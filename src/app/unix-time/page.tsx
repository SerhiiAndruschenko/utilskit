    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="container max-w-6xl  mx-auto px-4 py-8">
        ...
        <div className="relative">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl shadow-2xl mb-6 glow">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Convert between Unix timestamps and human-readable dates. Support for seconds, milliseconds, and multiple date formats.
          </p>
        </div>
