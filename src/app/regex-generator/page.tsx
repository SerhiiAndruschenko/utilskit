...
export const metadata: Metadata = {
  title: "Regex Generator - UtilsKit",
      ...
      <div className="max-w-6xl mx-auto p-6 pb-12 space-y-8">
        <div className="text-center space-y-4">
          <div className="relative">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl shadow-2xl mb-6 glow">
              <svg
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Generate regular expressions from examples and descriptions with
