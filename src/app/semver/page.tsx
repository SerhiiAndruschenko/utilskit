import SemverChecker from "@/components/SemverChecker";
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="relative">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Validate and compare semantic versions. Understand version differences and their impact on your projects.
          </p>
        </div>
