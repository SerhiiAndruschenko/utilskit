    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900">
      <div className="max-w-6xl mx-auto p-6 pb-12 space-y-8">
        ...
        <div className="relative">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-rose-600 to-pink-600 rounded-2xl shadow-2xl mb-6 glow">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Convert cURL commands to various programming languages with proper syntax and formatting
          </p>
        </div>
        <CurlToCode />
      </div>
